...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">DYNAMIC ALLOCATION TIMETABLE  SYSTEM</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/adminblock.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/library.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/adminblock1.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/library1.jpg" alt="Flower">
        </div>
    </div>
</div>
...
<br>
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentgrouptimetable.php" method="post">
        <select id="course_group_code" name="course_group_code" class="list-group-item">
            <option selected disabled>Select Course Group Code</option>
            <?php
            // Establish connection (assuming you have included connection.php)
            include 'connection.php';

            // Fetch course group codes from the database
            $query = "SELECT course_group_code FROM course_groups";
            $result = mysqli_query($conn, $query);

            // Loop through results and generate options
            while ($row = mysqli_fetch_assoc($result)) {
                echo "<option value='{$row['course_group_code']}'>{$row['course_group_code']}</option>";
            }
        ...
        <div style="display:none" id="facultyForm">
            <form action="facultyformvalidation.php" method="POST" style="overflow: hidden">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="facultyno" name="FN" placeholder="Staff No. ...">
                </div>
                <div class="form-group">
                   <label for="password">Password</label>
    ...
    <div class="container set-pad">
        ...
        <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/Gideon.jpeg" class="img-rounded"/>
                    <h3 align="center">PROF.  GIDEON MOI</h3>
                    <hr/>
                    <h4 align="center">Principal<br/> Chancellor</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/Henry.jpeg" class="img-rounded"/>
                    <h3 align="center">PROF.HENRY KIPLANGAT</h3>
                    <hr/>
                    <h4 align="center">Vice<br/>Chancellor</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/Maghanga.jpg" class="img-rounded"/>
                    <h3 align="center">DR. MOSES LESAMANA</h3>
                    <hr/>
                    <h4 align="center">Dean<br/>Faculty Engineering & Technology</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>Kabarak Univerity,
                </h4>
                <h4> Nakuru, Kenya</h4>
                <h4><strong>Call:</strong> 0727416037</h4>
                <h4><strong>Email: </strong>lmetheli@kabarak.ac.ke</h4>
            </div>
