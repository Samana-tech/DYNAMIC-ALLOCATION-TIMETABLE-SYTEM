...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" id="EnterSubject">
            ...
            <div style="display:none" id="addSubjectForm">
                <form action="addsubjectFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="subjectcode" name="SC" placeholder="COMP203 COMP205...">
                    </div>
                    <div class="form-group">
            ...
            <option value="1"> Jan April(Jan April Semester)</option>
            <option value="2"> May August(May August Semester)</option>
            <option value="3"> Sept Dec(Sept Dec Semester)</option>
                        </select>
                    </div>
                    <div class="form-group">
