...
if (!isset($_GET['unit_code']) || !isset($_GET['course_group_codes']) || !isset($_GET['day']) || !isset($_GET['lesson'])) {
    header("Location: makeup.php");
    exit();
}

$unit_code = $_GET['unit_code'];
$course_group_codes = explode(',', $_GET['course_group_codes']);
$day = $_GET['day'];
$lesson = $_GET['lesson'];
    ...
    <div class="container" style="margin-top: 70px;">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <form method="POST" action="bookmakeup.php" class="scrollable-form">
                    <input type="hidden" name="unit_code" value="<?php echo $unit_code; ?>">
                    <input type="hidden" name="course_group_codes" value="<?php echo implode(',', $course_group_codes); ?>">
                    ...
                    <button type="submit" class="btn btn-primary">Book Make-Up Class</button>
                </form>
            </div>
        </div>
    </div>
