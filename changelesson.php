...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("Location: fetchemptyroom.php?unit_code=$unit_code&course_group_code=$course_group_code&day=$day&lesson=$lesson");
    exit();
}
?>
<!DOCTYPE html>
    ...
    <div class="container" style="margin-top: 70px;">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <h2 class="custom-caption">Change Lesson Schedule</h2>
                <form method="POST" action="changelesson.php" class="scrollable-form">
                    ...
                    <div class="form-group">
                        <label for="course_group_code" class="custom-caption">Course Group Code:</label>
                        <select name="course_group_code" class="form-control" required>
                            <?php
