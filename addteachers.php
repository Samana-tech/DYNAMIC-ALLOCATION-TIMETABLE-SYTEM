        ...
        <div class="modal-body" id="EnterTeacher">
            ...
            <div style="display:none" id="addTeacherForm">
                <form action="addteacherFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="TF">Employee No</label>
                        <input type="text" class="form-control" id="facultyno" name="TF" placeholder="Emp No ...">
                    </div>
                    <div class="form-group">
                        <label for="TF">Initials</label>
                        <input type="text" class="form-control" id="alias_name" name="AL" placeholder="Initials..">
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="designation" name="TD">
                            ...
                            <option value="Assistant Professor">Dr</option>
                            <option value="Assistant Professor">Msc</option>
                            <option value="Associate Professor">Intern</option>
                            <option value="Guest Faculty">Guest Faculty</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="teachercontactnumber">Phone No.</label>
